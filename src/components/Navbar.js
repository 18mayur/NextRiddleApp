  ...
  return (
    <>
      <nav className="bg-gray-800">
        ...
        <div id="mobile-menu" className={`${isShow ? "block" : "hidden"} sm:hidden`}>
          <div className="space-y-1 px-2 pt-2 pb-3">
            <Link href="/" aria-current="page" className="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Home</Link>
            <Link href="/riddles" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Riddle</Link>
          </div>
        </div>
    </nav>
    </>
